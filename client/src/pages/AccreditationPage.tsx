...
export default function AccreditationPage({ onNavigate }: AccreditationPageProps) {
  ...
  return (
    <div className="animate-fadeIn pt-[140px] md:pt-[180px]">
      <PageHero
        title={t.pages.accreditation.title}
        subtitle={t.pages.accreditation.subtitle}
        breadcrumbs={[{ label: "Home", onClick: () => onNavigate("home") }, { label: "Accreditation" }]}
      />
